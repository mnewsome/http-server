...
public class ParameterDecodeResponseTest {
    ...
    public void testGenerate() {
        ...
        byte[] testResponse = new MockParameterDecodeResponse().generate(requestURI);
        byte[] resonse = new ParameterDecodeResponse().generate(requestURI);
        assertArrayEquals(testResponse, resonse);
    }
